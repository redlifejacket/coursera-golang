 ...
 * in a sorted slice. The program should be written as a loop.
 * Before entering the loop, the program should create an empty integer slice of
 * size (length) 3. During each pass through the loop, the program prompts the user
 * to enter an integer to be added to the slice. The program adds the integer to the
